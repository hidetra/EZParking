//
//  WestGarageViewController.swift
//  EZ Parking
//
...
class WestGarageViewController: UIViewController {
   ...
   func authenticateUserAndConfigureView() {
    ...
    func loadStatus() {
        Database.database().reference().child("parking").child("west").observe(.value, with: { (snapshot) in
